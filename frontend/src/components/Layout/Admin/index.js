...
const AdminNavbarLinks = ["calendar", "services", "bookings", "account"]
...
const MobileMenu = () => {
    ...
    return (
        <div className={`${mobileMenu ? 'translate-x-0' : 'translate-x-full'} transition-all ease-in-out duration-300 fixed inset-0 z-[150] h-screen bg-rest flex flex-col text-secondary lg:hidden`}>
            <div className='absolute top-8 right-10 md:right-[5rem]'>
                <MdOutlineClose
            ...
            <div className='absolute w-full top-[10%] flex flex-col  items-center justify-center '>
...
function Navbar() {
    ...
    return (
        <nav className={`fixed flex justify-between items-center px-10 sm:px-20 z-[100]  transition-all ease-linear duration-200 w-full max-w-[1980px]  h-[90px] bg-rest text-neutral-700`}>
