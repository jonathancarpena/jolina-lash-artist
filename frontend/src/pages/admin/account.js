...
function Account() {
    ...
    return (
        <div className='  absolute w-full left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] text-secondary '>
            <div className='bg-white rounded-xl  drop-shadow-xl h-screen px-5 pt-32 mx-auto md:h-max md:p-5 md:max-w-xl lg:max-w-3xl '>
                ...
                <div className='flex flex-col space-y-10'>
                    ...
                    <div>
                        ...
                        <form onSubmit={(e) => handleFormSubmit(e, 'password', password, oldPassword)} className='md:mx-5 flex flex-col space-y-3'>
                    ...
                    <div>
                        ...
                        <form onSubmit={(e) => handleFormSubmit(e, 'email', email, oldEmail)} className='md:mx-5 flex flex-col space-y-3'>
                            <div className='flex items-center'>
                    ...
                    <div>
                        ...
                        <form onSubmit={(e) => handleFormSubmit(e, 'phone', phone, oldPhone)} className='md:mx-5 flex flex-col space-y-3'>
                            <div className='flex items-center'>
