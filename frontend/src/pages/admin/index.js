...
const LoginModal = ({ setForgotPassword }) => {
    ...
    return (
        <div className='bg-neutral-100 p-10 rounded-xl drop-shadow-xl md:min-w-[450px]'>
            ...
            <form onSubmit={handleLoginSubmit} className='flex flex-col space-y-5 '>
                ...
                <div className=''>
                    <button
                        ...
                        className={`${(identity === "" || password === "") ? "bg-primary-400" : "bg-primary-500"}  p-3 rounded-lg text-white w-full mt-3 select-none`}
                        type='submit'>
                        Submit
                    </button>
                </div>
