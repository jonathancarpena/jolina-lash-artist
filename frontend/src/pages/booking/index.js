...
function Booking() {
  ...
  const [service, setService] = useState(
    location.state ? location.state.selected : null
  );
  ...
  return (
    <div className='min-h-screen bg-white flex flex-col pt-[5rem] md:pt-[6rem] lg:bg-transparent lg:pt-[14rem] lg:space-y-5 lg:px-20 xl:px-32 xl:pb-20'>
        ...
        header={
          <>
            ...
            {service ? (
              ...
              <p className='text-neutral-400 select-none text-base md:text-lg lg:text-xl '>
                (Choose Below)
              </p>
            )}
          </>
                      ...
                      {allServices[item].map((item, idx) => (
                        <div
                          ...
                          <input
                            ...
                            checked={
                              service !== null && item._id === service._id
                            }
                            disabled={
                              service !== null && item._id !== service._id
                            }
                          ...
                          <label
                            ...
                            <span className='ml-2 font-design'>
                              ${item.price}
                            </span>
                          </label>
                        </div>
      ...
      <Dropdown
            ...
            {bookDate && time ? (
              <p className='capitalize select-none font-design font-bold mt-1 text-base text-primary-800 lg:mt-0 md:text-2xl lg:text-3xl  xl:text-4xl'>
                <span className='hidden xl:inline-block'>
                  {moment(bookDate).format('dddd MMMM DD, YYYY')} @{' '}
                  <span className='uppercase'>{time}</span>
                </span>
                <span className='hidden md:inline-block xl:hidden'>
                  {moment(bookDate).format('ddd. MMM DD, YYYY')} @{' '}
                  <span className='uppercase'>{time}</span>
                </span>
                <span className='inline-block md:hidden'>
                  {moment(bookDate).format('MMM DD')}{' '}
        ...
        content={
          <div className='flex flex-col space-y-5 items-center px-5 pt-5 pb-10 border-b-2  md:flex-row md:px-10 md:space-x-10 md:space-y-0 lg:space-x-20 lg:py-10 lg:border-b-0'>
            <Calendar
              availableDays={availableDates.map((item) =>
              ...
              {bookDate && (
                <div className='flex flex-col space-y-5  lg:space-y-10'>
                  <h3 className='flex self-start text-xl lg:text-3xl xl:text-4xl  '>
                    <span>Time:</span>
                    <span className='ml-3 font-design uppercase'>{time}</span>
                  </h3>
        ...
        defaultOpen={location.state ? true : false}
        z={'z-[20]'}></Dropdown>
          ...
          <>
            ...
            <p className='flex items-center'>
              ...
              {quickValidate() ? (
                ...
                <span className='ml-4 text-neutral-400 select-none text-base md:text-lg lg:text-xl'>
                  (Fill Below)
                </span>
              )}
            </p>
            ...
            <div className='flex flex-col items-start space-y-1 md:flex-row md:space-x-3 md:space-y-0'>
              ...
              <p>
                ...
                <a
                  ...
                  rel='noopener noreferrer'>
                  <span className='underline underline-offset-1 mx-1'>
                    Terms & Conditions
                  </span>
                </a>
                and
      ...
      {quickValidate() && terms && bookDate && time && service && (
        <div
          className={`text-secondary bg-white py-6 px-5 z-0 md:p-6  lg:rounded-xl lg:p-8 lg:drop-shadow-lg`}>
          ...
          <div className='pt-10 pb-5 px-2 lg:px-5 '>
            <ul className='flex flex-col space-y-5'>
              <li className='text-xl lg:text-2xl'>
                ...
                <span className='capitalize ml-2'>
                  ...
                  {service.type && (
                    <span className='ml-1.5'>({service.type})</span>
                  )}
            ...
            <button
              ...
              className='w-full lg:w-max mt-10 bg-primary-400 hover:bg-primary-500 transition-all ease-in-out duration-200 text-white font-bold text-2xl px-6 py-4 rounded-lg uppercase'>
              Submit Order
            </button>
          </div>
        </div>
